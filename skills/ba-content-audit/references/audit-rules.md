...
| Project with >100 files | Batch by module. Process one module at a time: build index for module, audit module files, append findings, move to next module. Never load all-module ID data simultaneously. |
