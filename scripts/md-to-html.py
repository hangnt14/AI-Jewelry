...
def wrap_docsengine(html_path: Path) -> Path:
    ...
    SECTION_ICONS = {
        ...
        "dac-ta-use-case": "account_tree", "hop-dong-man-hinh": "screenshot",
        "danh-muc-man-hinh": "grid_view", "mo-ta-man-hinh": "description",
        "yeu-cau-phi-chuc-nang": "speed", "ascii-wireframes": "grid_view",
        "quy-tac-kinh-doanh": "gavel", "so-do-luong-du-lieu": "account_tree",
        "so-do-thuc-the-quan-he": "storage",
    }
    toc_items = ""
    for h in headings:
...
<span class="font-label-md text-label-md text-[13px]">{escape(h['text'])}</span>
    ...
    fill = {
        ...
        "{print_styles}": "@media print { aside { display: none; } main { margin-left: 0 !important; } .page-break { page-break-before: always; } }",
    }
